...
def page1():
    ...
    os.system('linear_regression.py')
...
page1btn = tkinter.Button(window, text="linear_regression", command=page1)
page1btn.place(x=80, y=100)
page2btn = tkinter.Button(window, text="KNN Algorithm", command=page2)
page2btn.place(x=80, y=100)
page3btn = tkinter.Button(window, text="naivebayes", command=page3)



page1text = tkinter.Label(window, text="This is KNN Algorithm")
page2text = tkinter.Label(window, text="This is linear_regression")
